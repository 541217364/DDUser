...
// }
    ...
    UIImageView *arrowimgview=[[UIImageView alloc]initWithFrame:CGRectMake(_ccpScrollView.frame.size.width-20,3,10,15)];
    
    arrowimgview.image=[UIImage imageNamed:@"rightwihte_arrow"];
    ...
    for (int i = 0; i < objArray.count; i++) {
        ...
        NSString *titleStr=objArray[i];
        
        if ([titleStr containsString:@"新用户"]) {
            
            UIImageView *imgview=[[UIImageView alloc]initWithFrame:CGRectMake(10,labelY,20,20)];
            
            imgview.image=[UIImage imageNamed:@"xin"];
            
            [self.ccpScrollView addSubview:imgview];
            
            labelX=30;
            
            labelW=self.ccpScrollView.frame.size.width-30-15;
            
        }
        
        if ([titleStr containsString:@"满"]) {
            
            UIImageView *imgview=[[UIImageView alloc]initWithFrame:CGRectMake(10,labelY,20,20)];
            
            imgview.image=[UIImage imageNamed:@"jian"];
        ...
        labelW=self.ccpScrollView.frame.size.width-30-15-15;
        ...
        titleLabel.frame = CGRectMake(labelX+5, labelY, labelW, labelH);
